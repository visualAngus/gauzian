...
export function useInfoPanel({ selectedItemsMap, formatBytes, addNotification, clearSelection, renameItem, downloadFile, deleteItem, shareItem }) {
    ...
    const handleRevokeAccess = (sharedUser) => {
        ...
        fetchWithAuth('/drive/revoke-access', {
            method: "POST",
            body: JSON.stringify({
