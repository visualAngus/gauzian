      ...
      >
        ...
        >
          <FileItem
            ...
            @accept="(item) => acceptSharedItem(item)"
            @reject="(item) => rejectSharedItem(item)"
            @restore="(item) => restoreItem(item)"
            @delete-permanent="(item) => deleteItem(item)"
          />
...
const displayFolderId = ref(activeFolderId.value);
watch(displayedDriveItems, () => {
  displayFolderId.value = activeFolderId.value;
});
