  ...
  <div class="page">
    <header>
      ...
      <div class="div-menu" style="display: none">
        <a class="a-menu" href="a_propos.html">
          <svg
        ...
        <a class="a-menu" href="parametres.html">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
          ...
          <Transition name="auth" mode="out-in">
            <div class="auth-block" key="register">
              ...
              <form @submit.prevent="handleRegister" autocomplete="on">
                ...
                <div class="pass-word-msg" :style="{ color: passwordMsgColor }">
                  {{ passwordMsg }}
                </div>
...
// login handled on /login page; removed from this component
