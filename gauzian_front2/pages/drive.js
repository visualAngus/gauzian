                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="additional_info">
                        ...
                        <span>
                          {activeSection === 'partages' ? new Date(content.expiration_date).toLocaleDateString('fr-FR', { weekday: 'short', day: 'numeric', month: 'short' }) : new Date(content.created_at).toLocaleDateString('fr-FR', { weekday: 'short', day: 'numeric', month: 'short' })}
                        </span>
                      </div>
